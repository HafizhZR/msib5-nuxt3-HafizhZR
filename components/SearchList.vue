  ...
  <div class="relative flex mx-auto justify-center mb-16">
    ...
    >
      ...
      <div class="flex mx-auto">
        <button
          type="submit"
          class="py-[10px] px-[20px] w-[150px] h-[48px] flex justify-center items-center text-center text-[#101828] bg-white border rounded-lg font-semibold"
        >
          <img class="pr-2" src="../assets/icons/Filter.png" alt="Filter" />Sort
          by
        </button>
      </div>
    </form>
